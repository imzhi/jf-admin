...
@section('head_css')
@parent
<link href="{{ asset('vendor/inspinia-admin/inspinia/css/plugins/daterangepicker/daterangepicker-bs3.css') }}" rel="stylesheet">
@endsection
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content clearfix">
                    <form action="{{ route('admin::show.setting.log') }}">
                        <div class="row">
                            <div class="col-md-3">
...
@section('foot_js')
@parent
<script src="{{ asset('vendor/inspinia-admin/inspinia/js/plugins/daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('vendor/inspinia-admin/inspinia/js/plugins/diff_match_patch/javascript/diff_match_patch.js') }}"></script>
<script src="{{ asset('vendor/inspinia-admin/inspinia/js/plugins/preetyTextDiff/jquery.pretty-text-diff.min.js') }}"></script>
<script>
