                ...
                <ul class="nav metismenu" id="side-menu">
                    {{-- <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span class="views-number"><a href="{{ route('jfadmin::show.index') }}">{{ config('jfadmin.title') }}</a></span>
                        </div>
                ...
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        {{-- <li class="dropdown">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li>
                                    <a href="{{ route('jfadmin::show.pwd') }}"><i class="fa fa-unlock-alt"></i> 修改密码</a>
                                </li>
                                <li class="divider"></li>
                                <li>
                                    <a href="{{ route('jfadmin::logout') }}"><i class="fa fa-sign-out"></i> 退出</a>
                                </li>
                            </ul>
                        </li> --}}
                    </ul>
